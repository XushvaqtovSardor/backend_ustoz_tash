...
let AuthService = class AuthService {
    ...
    async loginTeacher(payload) {
        ...
        const accessToken = await this.generateToken({ id: existEmail.id, email: existEmail.email, role: client_1.Role.TEACHER });
        return {
            success: true,
            accessToken
        };
    ...
    async loginStudent(payload) {
        ...
        const accessToken = await this.generateToken({ id: existEmail.id, email: existEmail.email, role: client_1.Role.STUDENT });
        return {
            success: true,
            accessToken
        };
